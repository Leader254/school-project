    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <!-- <img class="img-rounded" src="images/icn.pg" alt=""> -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <p class="pay-info">PayPal Accepted <img class="" src="images/paypal.png" alt="pal"></p>
                    <p class="pay-info">Lipa na Mpesa(Scan To Pay)</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="bottom-footer">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 address color-gray">
                        <h5>Address</h5>
                        <p>Kikuyu next to bus station opposite to powerstar supermarket</p>
